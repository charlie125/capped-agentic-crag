...
# ==========================================
plt.title('Decode Token Usage: Naive vs Uncapped vs Capped', fontsize=14)
plt.xlabel('Test Case ID', fontsize=11)
plt.ylabel('Decode Tokens Consumed', fontsize=11)
...
max_val = max(uncapped_tokens) if uncapped_tokens else 50
...
for d in OUT_DIRS:
    ...
    plt.savefig(d / "decode_tokens_per_question.png", dpi=400)
    print("wrote", d / "decode_tokens_per_question.png")
plt.show()