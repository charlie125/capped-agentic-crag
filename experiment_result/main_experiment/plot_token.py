...
plt.title('Total Token Usage: Naive vs Uncapped vs Capped', fontsize=14)
plt.xlabel('Test Case ID', fontsize=11)
plt.ylabel('Total Tokens Consumed', fontsize=11)
