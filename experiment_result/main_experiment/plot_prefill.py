...
# Commented-out save path renamed to prefill_tokens_per_question.png
for d in OUT_DIRS:
    d.mkdir(parents=True, exist_ok=True)
    plt.savefig(d / "prefill_tokens_per_question.png", dpi=400)
    print("wrote", d / "prefill_tokens_per_question.png")
plt.show()