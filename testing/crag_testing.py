...
def build_general_graph(use_memory=True, k=2):
...
def main(user_query, k=2) -> str:
    ...
    graph = build_general_graph(use_memory=False, k=k)
...
if __name__ == "__main__":
    main("Within how many hours must the DPO notify the supervisory authority of a breach likely to result in risk to data subjects?", 2)
